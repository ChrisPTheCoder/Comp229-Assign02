<%@ Page Title="StudentPage" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentPage.aspx.cs" Inherits="Comp229_Assign03.About" %>
                ...
                <td>
                        ...
                        <asp:DataList runat="server" ID="CourseList" OnItemCommand="Course_ItemCommand">
                            <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="CourseList" runat="server"
